	...
	_In_ INT       nCmdShow)
{
	...
	Engine::LoadTexture("Inori", "Res/IMG_9935.JPG");
	Engine::LoadTexture("Title", "Res/Title2.png");
	Engine::LoadTexture("Result", "Res/Result.png");
	Engine::LoadTexture("GameOver", "Res/GameOver.png");
...
void DrawProcessing()
{
	...
	Engine::DrawTexture(g_Position.X,g_Position.Y, "Enemy", 128, 0.0f, 1.0f, 1.0f);
